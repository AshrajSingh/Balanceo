...
import { expenseAtom, groupedExpenseState, isGroupedViewState } from "../store/userAtom"
import ConfirmBox from "./ConfirmBox"
import '../styleSheets/IncomePageTable.css'
import { useState } from "react"
import { deleteExpenses } from "../services/authService"
import toast from "react-hot-toast"

export function ExpensePageTable() {
    ...
    async function deleteItems(row) {
        console.log("expense_id in jsx: ", row._id)

        try {
            const deletedExpense = await deleteExpenses(row._id)
            console.log("deletedIncome from IncomeTable.jsx: ", deletedExpense)
